...
const Manager = () => {
    ...
    <>
      ...
      <div className="mycontainer">
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          ...
          <button className="flex justify-center items-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit border border-green-900" onClick={savePassword}>
            <lord-icon
  ...
  <tbody className='bg-green-100'>
    {passwordArray.map((item, index) =>{
      return <tr key={index}>
      <td className='py-2 border border-white text-center w-32'><a href={item.site} target='blank'>{item.site}</a></td>
